...
Local QA: `npx vitest run` 353/353 (43 files) PASS; Typecheck PASS. Playwright E2E 39 passed / 1 skipped / 0 failed (2026-08-21, post-redesign d313372). Lint has pre-existing issues only (1 `any` error in `e2e/print-qa.spec.ts`, 7 warnings, `next-env.d.ts` excluded). Chromium is installed.
