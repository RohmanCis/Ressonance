...
- **Layout:** Quiet, centered, full-screen `--bg-base`. One gold check mark (success glyph, not animated), event title in Cormorant Garamond 4xl, and two short lines of Bahasa-Indonesia receipt copy ("Terima kasih — foto dan pesan suara kamu sudah kami terima." and "Host akan melihatnya setelah acara.").
