...
export function GuestEventEntry({ publicId }: { publicId: string }) {
  ...
  function submitVoice() {
    ...
    request.onload = async () => {
      ...
      } catch { setVoiceState("review-error"); setVoiceMessage("The voice note was not confirmed as saved. Check your connection, then try again."); }
    };
    request.onerror = () => { setVoiceState("review-error"); setVoiceMessage("The voice note was not confirmed as saved. Check your connection, then try again."); }; request.send(form);
  }
